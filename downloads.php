    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" data-aos="fade-right">
       <a href="papers.php" >
        <div class="card text-center"  style="background: #f5f5f5;">
          <!-- <img class="card-img-top" src="https://images.pexels.com/photos/39811/pexels-photo-39811.jpeg?h=350&auto=compress&cs=tinysrgb" alt="" width="100%"> -->
          <div class="card-block p5">
              <img src="IMAGES/ICONS/Consulting-service-center.png " alt="Test" class="responsive-img pt20"><h4 class="card-title related-post-title text-center p0 m0">नागरिक सास्त्र</h4><h4 class="card-title related-post-title text-center english-title">(Sociology)</h4>
...
<!-- style="background: url('IMAGES/education-bac.png'); background-repeat: repeat;" -->
<section class=" search-paper p0">

 <div class="title-2 text-center mt-4 white">
 पिछले साल के प्रश्न पत्र खोजें
  </div>
  <form id="question-paper-search" method="post" style="margin-left: 15px;"
   >
  <div class="mb-4 p0" >
    <div class="row p0 col-md-10 offset-md-1" >
    <div class="search-paper-filter col-md-4">
    <div class="form-group">
      <label for="exampleFormControlSelect1" class="white">संस्थान का चयन करें</label>
    ...
    <div class="search-paper-filter col-md-4">
      <div class="form-group">
        <label for="exampleFormControlSelect1" class="white"> परीक्षा का चयन करें</label>
        <select class="form-control" id="exampleFormControlSelect1">
          <option>IAS</option>
          <option>IFS</option>
          <option>CDS</option>
    ...
    <div class="search-paper-filter col-md-4">
      ...
      <div class="form-group">
        <label for="exampleFormControlSelect1" class="white"> वर्ष का चयन करें</label>
        <select class="form-control" id="exampleFormControlSelect1">
          <option>2018</option>
          <option>2017</option>
          <option>2016</option>
    ...
    <div class="col-12 mt-4 text-center">
      <button type="submit" id="search-paper-button" class="do-btn-round-solid">Search Papers</button>
    </div>
