        ...
        <li class="list-inline-item">
          <div class="dropdown" id="more-exams" >
            ...
            <ul class="dropdown-menu">
              <li><a class="btn btn-default filter-button" data-filter="examone">UKPCS</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">MPPCS</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">BPCS</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">RPCS</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">CGPCS</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">HPCS</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">JPSC</a></li>
              <li><a class="btn btn-default filter-button" data-filter="state-pcs">HPPCS</a></li>
